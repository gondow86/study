...
#include <sys/time.h>
#define BUF_SIZE 80
#define GROUP_SIZE 32	/* Num of individuals in generation (tuning needed) */
#define LOOP_MAX 10000	/* Num of iterations of the main loop (tuning needed) */
/*
...
*/
#define MUTATION_RATE	0.20	/* tuning needed */
