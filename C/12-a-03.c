...
int main()
{
	...
	for (i = 0; i < ny; i++) {
		for (j = 0; j < nx; j++) {
			outimageR[i][j] = 255 * powf(inputimageR[i][j] / 255, 1 / gamma);///inputimage�̒l�����̂܂�outimage�֊i�[
			outimageG[i][j] = 255 * powf(inputimageG[i][j] / 255, 1 / gamma);///���ۂɂ̓t�B���^�����Ȃǂ��������̂�outimage�֊i�[
