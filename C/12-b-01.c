...
int main()
{
	...
	for (i = 0; i < ny; i++) {
		for (j = 0; j < nx; j++) {
			outimageR[i][j] = (inputimageR[i][j] + inputimageR2[i][j]) / 2;///inputimage�̒l�����̂܂�outimage�֊i�[
			outimageG[i][j] = (inputimageG[i][j] + inputimageG2[i][j]) / 2;///���ۂɂ̓t�B���^�����Ȃǂ��������̂�outimage�֊i�[
			outimageB[i][j] = (inputimageB[i][j] + inputimageB2[i][j]) / 2;
		}
	}
    /////////////////////////////////////////////////////////////////////////////
